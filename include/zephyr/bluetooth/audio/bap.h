...
#define BT_BAP_ADV_PARAM_BROADCAST_SLOW                                                            \
	BT_LE_ADV_PARAM(BT_LE_ADV_OPT_EXT_ADV, BT_GAP_MS_TO_ADV_INTERVAL(180),                     \
			BT_GAP_MS_TO_ADV_INTERVAL(180), NULL)
...
#define BT_BAP_PER_ADV_PARAM_BROADCAST_FAST                                                        \
	BT_LE_PER_ADV_PARAM(BT_GAP_MS_TO_ADV_INTERVAL(60), BT_GAP_MS_TO_ADV_INTERVAL(60),          \
...
#define BT_BAP_PER_ADV_PARAM_BROADCAST_SLOW                                                        \
	BT_LE_PER_ADV_PARAM(BT_GAP_MS_TO_ADV_INTERVAL(180), BT_GAP_MS_TO_ADV_INTERVAL(180),        \
			    BT_LE_PER_ADV_OPT_NONE)
