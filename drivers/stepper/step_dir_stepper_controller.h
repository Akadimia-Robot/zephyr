...
#ifndef ZEPHYR_DRIVER_STEPPER_STEP_DIR_STEPPER_CONTROLLER_H_
#define ZEPHYR_DRIVER_STEPPER_STEP_DIR_STEPPER_CONTROLLER_H_
...
#define STEP_DIR_STEPPER_DT_COMMON_CONFIG_INIT(node_id)                                            \
	{                                                                                          \
		...
		.dual_edge = DT_PROP_OR(node_id, dual_edge, false),                                \
	}
 ...
 *
 * This function moves the stepper motor by the specified number of micro_steps.
 *
 * @param dev Pointer to the device structure.
 * @param micro_steps Number of micro_steps to move. Can be positive or negative.
 * @return 0 on success, or a negative error code on failure.
 */
int step_dir_stepper_common_move(const struct device *dev, const int32_t micro_steps);

/**
 * @brief Set the maximum velocity in micro_steps per second.
 *
 * This function sets the maximum velocity of the stepper motor.
 *
 * @param dev Pointer to the device structure.
 * @param micro_steps_per_second Maximum velocity in micro_steps per second.
 * @return 0 on success, or a negative error code on failure.
 */
int step_dir_stepper_common_set_max_velocity(const struct device *dev,
					     const uint32_t micro_steps_per_second);

/**
 * @brief Set the reference position of the stepper motor.
 *
 * This function sets the reference position of the stepper motor.
 *
 * @param dev Pointer to the device structure.
 ...
 *
 * This function retrieves the current reference position of the stepper motor.
 *
 * @param dev Pointer to the device structure.
 ...
 *
 * This function sets the target position for the stepper motor.
 *
 * @param dev Pointer to the device structure.
 * @param value The target position to set.
 * @return 0 on success, or a negative error code on failure.
 */
int step_dir_stepper_common_set_target_position(const struct device *dev, const int32_t value);

/**
 * @brief Check if the stepper motor is still moving.
 *
 * This function checks if the stepper motor is moving towards the target position.
 *
 * @param dev Pointer to the device structure.
...
/**
 * @brief Enable constant velocity mode for the stepper motor.
 *
 * This function enables constant velocity mode, where the stepper motor moves continuously.
 *
 * @param dev Pointer to the device structure.
 * @param direction The direction of movement (positive or negative).
 * @param value The velocity in micro_steps per second.
 * @return 0 on success, or a negative error code on failure.
 */
int step_dir_stepper_common_enable_constant_velocity_mode(const struct device *dev,
...
#endif /* ZEPHYR_DRIVER_STEPPER_STEP_DIR_STEPPER_CONTROLLER_H_ */
