...
COND_CODE_1(DT_NODE_HAS_STATUS_OKAY(DT_INST(0, renesas_ra_rsip_e51a_trng)),
	    (RENESAS_RA_ENTROPY_DEVICE_DEFINE(DT_INST(0, renesas_ra_rsip_e51a_trng))), ())

COND_CODE_1(DT_NODE_HAS_STATUS_OKAY(DT_INST(0, renesas_ra_sce7_rng)),
	    (RENESAS_RA_ENTROPY_DEVICE_DEFINE(DT_INST(0, renesas_ra_sce7_rng))), ())
