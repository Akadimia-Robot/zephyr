...
static int test_sysbus(void)
{
	 ...
	 *  integrity
	 */
	const uint32_t addr[] = {0x710, 0x714, 0x71c, 0x720,
							0x728, 0x72c, 0x734, 0x738};
	const uint32_t val_arr[] = {
		0x110f03f, 0x000003f3, 0x0110f13f, 0x000003f3,
		0x0003073f, 0x3013f0f, 0x0003073f, 0x03013f8f};
