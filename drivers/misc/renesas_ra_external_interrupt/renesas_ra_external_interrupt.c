...
#define _ELC_EVENT_ICU_IRQ(channel) ELC_EVENT_ICU_IRQ##channel
#define ELC_EVENT_ICU_IRQ(channel)  _ELC_EVENT_ICU_IRQ(channel)

#define _EXT_INTERRUPT_SAMPLE_CLOCK_DIV(div) EXT_INTERRUPT_SAMPLE_CLOCK_DIV_##div
#define EXT_INTERRUPT_SAMPLE_CLOCK_DIV(div)  _EXT_INTERRUPT_SAMPLE_CLOCK_DIV(div)
...
#define GPIO_INTERRUPT_INIT(index)                                                                 \
	...
	{                                                                                          \
		R_ICU->IELSR[DT_INST_IRQ(index, irq)] =                                            \
			ELC_EVENT_ICU_IRQ(DT_INST_PROP(index, channel));                           \
